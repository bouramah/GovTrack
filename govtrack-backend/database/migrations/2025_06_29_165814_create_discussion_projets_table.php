...
return new class extends Migration
{
    ...
    {
        Schema::create('discussion_projets', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('parent_id')->nullable()->constrained('discussion_projets')->onDelete('cascade')->comment('Réponse à un message (nullable)');
            ...
            $table->index(['projet_id', 'date_creation']);
    ...
    {
        Schema::dropIfExists('discussion_projets');
    }
};
