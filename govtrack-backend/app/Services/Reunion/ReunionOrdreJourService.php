    ...
    public function addPointOrdreJour(int $reunionId, array $data, User $user): array
    {
        try {
            ...
            $pointData = [
                ...
                'entite_proposante_id' => $data['entite_proposante_id'] ?? null,
                'responsable_id' => $data['responsable_id'] ?? null,
                'projet_id' => $data['projet_id'] ?? null,
                'statut' => 'PLANIFIE',
                'niveau_detail_requis' => $data['niveau_detail_requis'] ?? 'SIMPLE',
                'creer_par' => $user->id,
    ...
    public function updatePointOrdreJour(int $pointId, array $data, User $user): array
    {
        try {
            ...
            $updateData = array_filter([
                ...
                'niveau_detail_requis' => $data['niveau_detail_requis'] ?? null,
                'modifier_par' => $user->id,
                'date_modification' => now(),
            ], function ($value) {
                return $value !== null;
